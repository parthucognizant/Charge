...
public class DTHActivity extends Fragment implements OnItemSelectedListener, OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.activity_dth, container, false);
		mySpinner = (Spinner) rootView.findViewById(R.id.mobile_number_spinner);
		provider = (EditText)rootView.findViewById(R.id.dth_provider_edit);
		provider.setEnabled(false);
		amount = (EditText)rootView.findViewById(R.id.dth_amount_edit);
		btproceed = (Button)rootView.findViewById(R.id.dth_button);
	...
	class dth extends AsyncTask<String, String, String[]> {
