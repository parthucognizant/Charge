...
public class DataCardActivity extends Fragment implements OnItemSelectedListener, OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.activity_data_card, container, false);
		mySpinner = (Spinner) rootView.findViewById(R.id.mobile_number_spinner);
		provider = (EditText)rootView.findViewById(R.id.datacard_provider_edit);
		provider.setEnabled(false);
		amount = (EditText)rootView.findViewById(R.id.datacard_amount_edit);
		btproceed = (Button)rootView.findViewById(R.id.datacard_button);
	...
	class datacard extends AsyncTask<String, String, String[]> {
		...
		protected void onPostExecute(String[] result) {
			...
			ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(getActivity().getBaseContext(),android.R.layout.simple_spinner_item, result);
